...
@property (assign, nonatomic) UILabel *temperatureLabel;
@property (assign, nonatomic) UILabel *hiloLabel;
@property (assign, nonatomic) UILabel *cityLabel;
@property (assign, nonatomic) UILabel *conditionsLabel;
@property (assign, nonatomic) UIImageView *iconView;
